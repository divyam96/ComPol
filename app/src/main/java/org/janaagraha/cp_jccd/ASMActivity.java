...
public class ASMActivity extends AppCompatActivity {
    ...
    public void refresh_ASMdeleted(View view){
        syncfordeleted();
    }
    ...
    public void syncSQLiteMySQLDB() {
        ...
        client.post("http://gpstracker.janaagraha.in/DatabaseUpdate/ASMnames/getasms.php", params, new AsyncHttpResponseHandler() {
            @Override
    ...
    public void updateSQLiteDel(String response){
        // Create GSON object
        Gson gson = new GsonBuilder().create();
        try {
            // Extract JSON array from the response
